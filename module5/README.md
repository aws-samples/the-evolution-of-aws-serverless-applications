...
1. 로컬 환경에서 [AWS X-Ray SDK for Python](https://docs.aws.amazon.com/xray/latest/devguide/xray-sdk-python.html) 를 다운로드 하여 ZIP으로 압축시키거나, 다음 [링크](https://github.com/aws-samples/aws-games-sa-kr/blob/main/contributor/anhyobin/optimize-serverless-application-on-aws/module5/src/xray.zip)를 통해 AWS X-Ray SDK ZIP 파일을 다운로드 받습니다.
