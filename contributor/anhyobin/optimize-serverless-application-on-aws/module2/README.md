...
9. [Security group name] 에는 **lambda-sg** 를 입력하고 [Description] 을 적은  [VPC] 는 앞서 생성한 **serverless-app** 을 선택합니다. Lambda 의 경우 별도의 인바운드 규칙이 필요하지 않습니다. 하단의 [Create security group] 버튼을 클릭하여 완료합니다.
